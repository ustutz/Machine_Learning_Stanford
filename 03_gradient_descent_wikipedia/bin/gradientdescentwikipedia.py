...
class Main:
    _hx_class_name = "Main"
    __slots__ = ()
    _hx_methods = ["f_derivative"]
    _hx_statics = ["main"]

    def __init__(self):
        x_old = 0.0
        x_new = 6.0
        while (Reflect.field(Math,"fabs")((x_new - x_old)) > 0.00001):
            x_old = x_new
            x_new = (x_old - ((0.01 * self.f_derivative(x_old))))
            print(str(("x_new " + str(x_new))))
        print(str(("Local minimum occurs at " + str(x_new))))
